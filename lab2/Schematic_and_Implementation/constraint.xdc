...
set_property PACKAGE_PIN V16 [get_ports {LB}] 			

set_property IOSTANDARD LVCMOS33 [get_ports {LB}] 

set_property PACKAGE_PIN W16 [get_ports {LP}] 			

set_property IOSTANDARD LVCMOS33 [get_ports {LP}] 

set_property PACKAGE_PIN W17 [get_ports {on}] 			
...
set_property IOSTANDARD LVCMOS33 [get_ports {battery_led}]	
...
set_property IOSTANDARD LVCMOS33 [get_ports {led_1v}]	

set_property PACKAGE_PIN P1 [get_ports {led_2v}]

set_property IOSTANDARD LVCMOS33 [get_ports {led_2v}]	

set_property PACKAGE_PIN L1 [get_ports {led_3v}]

set_property IOSTANDARD LVCMOS33 [get_ports {led_3v}]	
