...
set_property PACKAGE_PIN V17 [get_ports {reset}] 		//reset

set_property IOSTANDARD LVCMOS33 [get_ports {reset}] 

set_property PACKAGE_PIN V16 [get_ports {LB}] 			//low battery

set_property IOSTANDARD LVCMOS33 [get_ports {LB}] 

set_property PACKAGE_PIN W16 [get_ports {LP}] 			//low power

set_property IOSTANDARD LVCMOS33 [get_ports {LP}] 

set_property PACKAGE_PIN W17 [get_ports {on}] 			//on/off
...
set_property PACKAGE_PIN V19 [get_ports {power_led}]

set_property IOSTANDARD LVCMOS33 [get_ports {power_led}]	//Low power indication

set_property PACKAGE_PIN W18 [get_ports {battery_led}]		

set_property IOSTANDARD LVCMOS33 [get_ports {battery_led}]	//Low battery indication
...
set_property PACKAGE_PIN P3 [get_ports {ready}]

set_property IOSTANDARD LVCMOS33 [get_ports {ready}]	//ready signal LED

set_property PACKAGE_PIN N3 [get_ports {led_1v}]

set_property IOSTANDARD LVCMOS33 [get_ports {led_1v}]	//1.2V regulator LED

set_property PACKAGE_PIN P1 [get_ports {led_2v}]

set_property IOSTANDARD LVCMOS33 [get_ports {led_2v}]	//2.5V regulator LED

set_property PACKAGE_PIN L1 [get_ports {led_3v}]

set_property IOSTANDARD LVCMOS33 [get_ports {led_3v}]	//3.3V regulator LED
